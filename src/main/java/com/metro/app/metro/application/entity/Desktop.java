...
public class Desktop {
	...
	public Desktop(String serialNumber, String model, String deviceMac, String processor, String screenSize,
	...
	public String toString() {
		return "Desktop [serialNumber=" + serialNumber + ", model=" + model + ", deviceMac=" + deviceMac + ", processor="
