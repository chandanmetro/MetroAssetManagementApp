...
public class Laptop {
	...
	public Laptop(String serialNumber, String model, String deviceMac, String processor, String screenSize,
	...
	public String toString() {
		return "Laptop [serialNumber=" + serialNumber + ", model=" + model + ", deviceMac=" + deviceMac + ", processor="
